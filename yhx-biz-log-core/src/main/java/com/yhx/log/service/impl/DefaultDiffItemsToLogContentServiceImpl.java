...
import com.yhx.log.annotation.DiffField;
...
@Slf4j
@AllArgsConstructor
public class DefaultDiffItemsToLogContentServiceImpl implements DiffItemsToLogContentService {
    ...
    private String getFieldLogName(DiffNode node, DiffField diffLogFieldAnnotation) {
    ...
    private String getParentFieldName(DiffNode node) {
        ...
        while (parent != null) {
            DiffField diffLogFieldAnnotation = parent.getFieldAnnotation(DiffField.class);
